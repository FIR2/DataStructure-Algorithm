// define a class ArrayADT with member variables capacity,lastindex,and ptr. with member functions
//  createArray(int cap),append(int data), & insertArray(int index, int data),
#include<conio.h>
#include<iostream>
#include<stdlib.h>
using namespace std;
